...
class EvidentialMultifidelityMPNN(MultifidelityRegressionMPNN):
    ...
    def __init__(self, mpn_block, n_tasks=1, mpn_block_low_fidelity=None, init_lr=0.01, max_lr=0.05, final_lr=0.001):
...
class MveMultifidelity(MultifidelityRegressionMPNN):
    ...
    def __init__(self, mpn_block, n_tasks=1, mpn_block_low_fidelity=None):
        super().__init__(mpn_block=mpn_block, 
                         mpn_block_low_fidelity=mpn_block_low_fidelity, 
                         n_tasks=n_tasks, 
                         init_lr=0.01, 
